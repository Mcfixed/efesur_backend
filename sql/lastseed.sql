-- =====================================================
-- EFE Project - Seed Data (Optimizado y Relacional)
...
-- Old atencion alert (outside 30 minute window)
INSERT INTO alerts (device_id, type, status, metadata, created_at) VALUES
...
-- Resolved alert example (Nota: Se corrigió el correo a admin@wisensor.cl ya que @efe.cl no existía)
...
-- Tracking para alerta del GPS-003
...
-- Tracking para alerta del GPS-005
